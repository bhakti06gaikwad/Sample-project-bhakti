...
<input  class="cbcheck" type="checkbox" name="notUsed" id="notUsed4"  onclick="clearField('inputvalue4', 'result4')">
                    ...
                    <li class="list">
                        <div class="appliance-item">
                            <img class="icon" src="iconimage\other_icon.png" alt="other_icon">
                        </div>
...
// $c = "CREATE TABLE appliances (
//     id INT  ,
//     datea DATE,
//     appliances_meta_count FLOAT,
//     FOREIGN KEY (id)
//     REFERENCES login_info(id)
//      )"; 
// $re = mysqli_query($conn, $c);

// Check if the ID exists in login_info
$login_id = 3; // Example id
