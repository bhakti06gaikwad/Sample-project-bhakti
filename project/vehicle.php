...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT vehicle_meta_count FROM vehicle WHERE Datea = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        if ($metacount != $existingMetaCount) {
            ...
            $updateQuery = "UPDATE vehicle SET vehicle_meta_count = ? WHERE Datea = ?";
        ...
        $insertQuery = "INSERT INTO vehicle (Datea, vehicle_meta_count) VALUES (?, ?)";
